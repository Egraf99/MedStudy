...
class Ui_SetCircleDialog(object):
    def setupUi(self, SetCircleDialog):
        ...
        self.label = QtWidgets.QLabel(self.question_comboBox)
        ...
        self.circle_check_box = QtWidgets.QCheckBox(SetCircleDialog)
        self.circle_check_box.setObjectName("circle_check_box")
        self.horizontalLayout_2.addWidget(self.circle_check_box)
    ...
    def retranslateUi(self, SetCircleDialog):
        ...
        self.label.setText(_translate("SetCircleDialog", "При ответе"))
        ...
        self.label_2.setText(_translate("SetCircleDialog", "открываются"))
        self.circle_check_box.setText(_translate("SetCircleDialog", "и повторяются"))
